## nav2_minimal_turtlebot_simulation (rolling) - 1.3.0-1

The packages in the `nav2_minimal_turtlebot_simulation` repository were released into the `rolling` distro by running `/usr/bin/bloom-release nav2_minimal_turtlebot_simulation --track rolling --rosdistro rolling --edit` on `Mon, 27 Jul 2026 16:46:38 -0000`
...
## nav2_minimal_turtlebot_simulation (lyrical) - 1.3.0-1

The packages in the `nav2_minimal_turtlebot_simulation` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release nav2_minimal_turtlebot_simulation --track lyrical --rosdistro lyrical --edit` on `Tue, 21 Jul 2026 21:56:14 -0000`
...
## nav2_minimal_turtlebot_simulation (rolling) - 1.2.0-1

The packages in the `nav2_minimal_turtlebot_simulation` repository were released into the `rolling` distro by running `/usr/bin/bloom-release nav2_minimal_turtlebot_simulation --rosdistro rolling --track rolling --edit` on `Thu, 29 May 2025 22:34:53 -0000`
...
## nav2_minimal_turtlebot_simulation (kilted) - 1.2.0-1

The packages in the `nav2_minimal_turtlebot_simulation` repository were released into the `kilted` distro by running `/usr/bin/bloom-release nav2_minimal_turtlebot_simulation --rosdistro kilted --track kilted --edit` on `Thu, 29 May 2025 22:29:38 -0000`
...
## nav2_minimal_turtlebot_simulation (rolling) - 1.1.0-2

The packages in the `nav2_minimal_turtlebot_simulation` repository were released into the `rolling` distro by running `/usr/bin/bloom-release nav2_minimal_turtlebot_simulation --rosdistro rolling --track rolling` on `Tue, 15 Apr 2025 22:36:00 -0000`
