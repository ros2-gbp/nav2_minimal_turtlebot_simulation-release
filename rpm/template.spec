...
Name:           ros-kilted-nav2-minimal-tb4-sim
Version:        1.2.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS nav2_minimal_tb4_sim package

License:        Apache 2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-kilted-nav2-minimal-tb4-description
...
BuildRequires:  ros-kilted-nav2-minimal-tb4-description
...
%changelog
* Thu May 29 2025 Steve Macenski <steve@opennav.org> - 1.2.0-1
