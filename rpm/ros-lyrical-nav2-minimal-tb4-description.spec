...
%global pkg_name nav2_minimal_tb4_description
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-nav2-minimal-tb4-description
Version:        1.3.0
Release:        1%{?dist}
...
%changelog
* Tue Jul 21 2026 Steve Macenski <steve@opennav.org> - 1.3.0-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Steve Macenski <steve@opennav.org> - 1.2.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Steve Macenski <steve@opennav.org> - 1.2.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Steve Macenski <steve@opennav.org> - 1.2.0-1
- Autogenerated by Bloom
